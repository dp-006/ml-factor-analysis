...
class DescriptiveAnalysis:
    """Performs descriptive analysis on a generated classification dataset."""

    def __init__(self):
        logger.info("DescriptiveAnalysis initialized.")

    def load_data_schema(self, data_schema: Union[dict, str] = None) -> dict:
        """
...
if __name__ == "__main__":
    ...
    data_schema = (descriptive_analysis.load_data_schema(input_schema_path)).get('column_dtypes')
    X_train = pd.read_csv(input_data_path, dtype=data_schema)   
    _ = descriptive_analysis.get_descriptive_statistics(df=X_train)
